...
const variantStyles: Record<ButtonVariant, string> = {
  ...
  secondary:
    "bg-surface-secondary text-foreground hover:bg-neutral-200 active:bg-neutral-300 border border-border",
  outline:
...
export function Button({
  ...
  return (
    <button
      className={cn(
        "inline-flex items-center justify-center font-medium rounded-[var(--radius-md)] transition-all cursor-pointer",
